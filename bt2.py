...
hdd = zan.PWM(7 , 40000)    #HANDLING
hdc = zan.PWM(12, 40000)    #HANDLING
mpx = zan.PWM(4, 1000)   #PENENDANGy
mpy = zan.PWM(17, 1000)   #PENENDANGx
...
def caribola():
    ...
    if(bola !=[]):  
        ...
        PID=abs(PID)
        errors=error
        if(yp>208 and xp>130 and xp<170):
            hand = 100
            if siapa == 'bot2':
                if ket == 'bot2ketemu':
                    z = 44 #cari gawang
...
def kegawang():
    ...
    if(areaGaw !=[]):
        ...
        if(ypg>80 and xpg>120 and xpg<210):
            z = 22 #cari kawan
...
while (1):
    ...
    try:
    	if nah == '`' :
    		serper.close()
    		break
        elif (nah == 'bot2start') or (nah== 'lepas1'):
            if nah == 'bot2start':
                siapa = 'bot2'
                z = int(nah.replace('bot2start', '0'))
            elif nah == 'lepas1':
                z = int(nah.replace('lepas1', '0'))
            else:
                pass
        elif (nah == 'bot1ketemu'):
            z = int(nah.replace('bot1ketemu', '33'))
        elif (nah == 'bot1start'):
            siapa = 'bot1'
            z = int(nah.replace('bot1start', '22'))
        elif nah == 'nembak':
